...
│ └── vpc/ # VPC, subnets, NAT & Internet Gateways
├── README.md
...
- **VPC & Networking**: Public & private subnets, Internet Gateway, NAT Gateways, route tables.
...
- An AWS account with permissions for EC2, VPC, ELB, AutoScaling, IAM, S3 (if needed)
